...
| AQFT_V3.1_Architecture_Optimization_Directive_V1.0.md | V1.0.0 | ✅ FINAL（V3.1优化指令） |
...
| AQFT_Autonomous_Evolution_Roadmap_V1.0.md | V1.0.0 | ✅ FINAL（自主进化路线图） |
...
| AQFT_EP_Governance_Stable_V1.0.md | V1.0.0 | ✅ FINAL（治理稳定宣言） |
| AQFT_Governance_Stable_Final_Declaration_V1.0.md | V1.0.0 | ✅ FINAL（治理稳定最终宣言） |
...
| AQFT_World_Model_Architecture_V3.0.0.md | V3.0.0 | ✅ FINAL |
